...
public class Bombe extends Personnage {
    ...
    public void bombExplosion(Labyrinthe laby, Personnage player) {
        ...
        if (this.dropTime+player.getBombDuration() == System.currentTimeMillis()/1000 || this.explosion) {
            ...
            this.animationTime = System.currentTimeMillis()+300;
    ...
    public void bombMove(Personnage player) {
        if (this.move) {
            if (direction.equals("up")) {
                this.setPosBombY(this.getPosBombBlocY() + 0.5);
                StdDraw.setPenColor(Color.blue);
                // dessin du personnage
                StdDraw.filledCircle(this.getPosBombBlocX(), this.getPosBombBlocY()+ 1, SIZE_PLAYER / 2);
            }
        }
    }
}
